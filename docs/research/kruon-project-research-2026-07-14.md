...
| 当前阶段 | M1-M3 实现闭环完成；M4 DEV-401～406 仓库预审已推进，外部发布、独立安全评审与真人研究门仍开放 |
...
## 4. 当前真实进度评估（对照里程碑）
### 总体判断：M1-M3 实现闭环已完成，M4 DEV-401～406 的兼容、故障、隐私诊断、打包契约、首次连接与安全预审已落地；外部发布、独立安全评审与真人研究门仍开放。
| 里程碑 | 范围 | 状态 | 关键证据 |
|---|---|---|---|
...
| **M4 (W9-W10)** 邀请制 Alpha | 兼容/安全/打包/用户 | ⚠️ 进行中 | DEV-401～403 已验证；DEV-404 仓库契约完成但外部 Apple 门开放；DEV-405 已实现 onboarding；DEV-406 已完成信任撤销、SQLite 加固、安全漂移门和外部评审包，但独立评审仍开放；DEV-407 开放 |
